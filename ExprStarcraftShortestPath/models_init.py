...
class SudokuLSTM(nn.Module):
    def __init__(self, boardSz, hidden_dim=128):
        ...
        # self.lstm = nn.LSTM(batch_first=True, input_size=9, hidden_size=hidden_dim, num_layers=3, bidirectional=True, dropout=0.0)
        self.lstm = nn.RNN(batch_first=True, input_size=9, hidden_size=hidden_dim, num_layers=5, bidirectional=True, nonlinearity='tanh', dropout=0.2)
...
class CNNLSTM(nn.Module):
    def __init__(self, out_features, in_channels, arch_params):
        super().__init__()
